...
TEMPLATES = (
    ...
    "In practice, {focus} becomes visible through small decisions.",
    "This perspective turns {focus} into something you can practice.",
    "The takeaway is to let {focus} guide the next choice.",
    "Real change happens when {focus} moves into daily action.",
    ...
    "The practical focus is {focus} applied one choice at a time.",
    "This takeaway brings {focus} back to everyday behavior.",
    "The lesson is clearer when {focus} shapes ordinary decisions.",
    "This perspective makes {focus} useful beyond the page.",
    "Daily choices are where {focus} starts becoming real.",
    "The idea becomes practical when {focus} influences what follows.",
    ...
    "In everyday life, {focus} grows through deliberate choices.",
    "The lesson places {focus} inside the choices you make.",
    "This idea asks how {focus} can shape daily action.",
    "The practical takeaway is {focus} expressed through consistent action.",
